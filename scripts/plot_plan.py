...
df = pd.DataFrame(
    [
        ...
        dict(
            Task="Object Detection and Regression Literature Review",
            Start="2021-10-19",
            Finish="2021-10-31",
            Type="Report",
        ),
        dict(
            Task="Collect and annotate Street View Images",
            Start="2021-10-18",
            Finish="2021-10-31",
            Type="Data Collection",
        ),
        ...
        dict(
            Task="Create Litter Detection Model",
            Start="2021-10-18",
            Finish="2021-12-01",
            Type="Implementation",
        ),
        dict(
            Task="Quantify Glasgow Ward Litter",
            Start="2021-12-01",
            Finish="2021-12-07",
            Type="Implementation",
        ),
